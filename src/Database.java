...
public class Database {
	...
	public Database() {
		PokemontextFile = "POKEMON.txt";
		UserTextFile = "UserProfile.txt";
		TopScoreList = "TopScoreList.txt";
	}
    ...
    public void writeUserTextFile(ArrayList<UserAccount> userlist) {
    	try(BufferedWriter writer = new BufferedWriter(new FileWriter(getUserTextFile(), true))) {
